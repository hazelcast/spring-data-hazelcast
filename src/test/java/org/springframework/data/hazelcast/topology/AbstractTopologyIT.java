...
/**
 * <P>A single Hazelcast instance is sufficient for most tests,
 * but does not confirm the operations invoked via Spring Data
 * Hazelcast are distributed.
 * </P>
 * <P>Define common tests to prove distribution, for use in more
 * advanced topologies. The nature of these tests is to have more
 * than one Hazelcast instance, and to verify object state on
 * an instance other than the one Spring is using.
 * </P>
 * <P>Note that when multiple Hazelcast instances are used,
 * they are all part of the same JVM. This is to simplify
