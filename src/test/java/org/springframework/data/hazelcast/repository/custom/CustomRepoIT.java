...
public class CustomRepoIT
    ...
    public void movieRepositorySpecificBehaviour() {
        ...
        assertThat(String.format("Some movies found with word '%s' in title title", WORD), allWithWord, greaterThan(0));
        assertThat(String.format("Not all movies found with word '%s' in title title", WORD), allWithWord, lessThan(all));
        ...
        @SuppressWarnings("unchecked") List<Movie> resultList = (List<Movie>) result;
    ...
    public void songRepositorySpecificBehaviour() {
        ...
        assertThat("1934 through 1938", resultList,
                containsInAnyOrder(hasProperty("id", equalTo("1934")), hasProperty("id", equalTo("1935")),
                        hasProperty("id", equalTo("1936")), hasProperty("id", equalTo("1937")),
