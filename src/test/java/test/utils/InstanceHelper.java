...
/**
 * <P>Bootstrap Spring objects as part of test context. Creates a {@link HazelcastInstance} {@code @Bean}
 * for all tests, and uses {@link EnableHazelcastRepositories @EnableHazelcastRepositories} to initiate
...
public class InstanceHelper {
	...
	/** 
	 * <P>{@link org.springframework.data.keyvalue.core.KeyValueOperations KeyValueOperations} are
	 * implemented by a {@link org.springframework.data.keyvalue.core.KeyValueTemplate KeyValueTemplate} 
     * that uses an adapter class encapsulating the implementation.
	 * </P>
    ...
    public KeyValueOperations keyValueTemplate() {
        return new KeyValueTemplate(
                new HazelcastKeyValueAdapter(this.hazelcastInstance));
    }
	...
	/**
	 * <P>A single Hazelcast instance is the simplest, and sufficient for
	 * most of the tests.
	 * </P>
	 */
	@Configuration
	...
	public static class Singleton {
	    /**
	     * <P>Create a singleton {@link HazelcastInstance} server {@code @Bean}.
	     * </P>
	...
	/**
	 * <P>Create a cluster with more than one instance, for use in
	 * more complex tests.
	 * </P>
	 * <P>Although one per JVM is more typical, create them all in
	 * the one JVM to simplify control from JUnit.
	 * </P>
	 * <P>To avoid overloading the JVM, "multiple" instances means 2.
	 * </P>
	 */
	@Configuration
	...
	public static class Cluster {
	    /**
	     * <P>Create two {@link HazelcastInstance} server {@code @Bean}s
	     * clustered together.
	     * </P>
	...
	/**
	 * <P>Create a client-server topology, for use in
	 * more complex tests.
	 * </P>
	 * <P>As per {@code Constants.SPRING_TEST_PROFILE_CLUSTER},
	 * these instances are all in the one JVM and the minimum
	 * number (1 client, 1 server) is made.
	 * </P>
	 */
	@Configuration
	...
	public static class ClientServer {
	    /**
	     * <P>Create a client-server topology, using one {@link HazelcastInstance}
	     * server and one {@link HazelcastInstance} client. The client is the
	     * returned as the {@code @Bean}.
	     * </P>
	...
	/**
	 * <P>Create a cluster using {@code 127.0.0.1:5701} as the master. The
	 * master must be created first, and may be the only server instance
	 * in this JVM. 
	 * </P>
	 * 
	...
	/**
	 * <P>Create a client that can connect to the cluster via the
	 * master server {@code 127.0.0.1:5701}. The server will be in
